    ...
    >
      <div className="relative h-[calc(100vh+400px)] sm:h-[calc(100vh+600px)] lg:h-[calc(100vh+800px)] -top-[100vh]">
        <div className="h-[400px] sm:h-[600px] lg:h-[800px] sticky top-[calc(100vh-400px)] sm:top-[calc(100vh-600px)] lg:top-[calc(100vh-800px)] flex flex-col justify-end px-4 sm:px-6 py-4 sm:py-6 lg:py-8">
          ...
          {/* Links Section slightly left from center */}
          <div className="flex justify-end items-start mb-16">
            <div className="absolute top-1/2 left-[40%] flex space-x-12 -translate-y-1/2">
              
              {/* Column 1 (starts slightly left from center) */}
              <div className="flex flex-col items-center space-y-1">
                <Link
                  href="/privacy"
                  className="text-white text-base hover:text-[#FF6B35]"
                >
                  Privacy Policy
                </Link>
                <Link
